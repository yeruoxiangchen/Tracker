...
def infer(opt_file_path, foundpose_detection, image_raw, camK, model_tpath):
    ...
    timer.elapsed("Time for setting up the stage")      # 0.52
    ...
    for object_lid in object_lids:
        ...
        timer.elapsed("Time for preparing object data")       # 1.35s
