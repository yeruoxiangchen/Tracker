...
def infer(opt_file_path, image_raw, mask_raw, camK, frame_name) -> None:
    ...
    for object_lid in object_lids:
        ...
        for inst_j, instance in enumerate(instances):
            ...
            # output_filename = f"/home/zjr/Tracker/foundpose/results/refine_model/wogua/2d-2d-omni/match_viz_{frame_name}_tpl{best_template_id}.png"
            frame_clean = os.path.splitext(frame_name)[0]
            save_dir = "/home/zjr/Tracker/foundpose/results/refine_model/wogua/2d-2d-omni"
...
def main() -> None:
    ...
    model_path = os.path.join(base_dir, "models/wogua.obj")
    output_vis_dir = "/home/zjr/Tracker/foundpose/results/refine_model/wogua"
    data_cache_path = os.path.join(os.path.dirname(opts_path), "cached_optimization_data_infer11_wogua.pkl")
    ...
    result = least_squares(
        ...
        method='tfr', # Levenberg-Marquardt 算法
        verbose=2
