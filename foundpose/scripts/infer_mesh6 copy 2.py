...
def main() -> None:
    ...
    data_cache_path = os.path.join(os.path.dirname(opts_path), "cached_optimization_data_infer6.pkl")
    ...
    for data in all_optimization_data:
        X_m = data['X_3d']
        X_c = (R_m2c @ X_m.T).T + t_m2c
        data['X_3d'] = X_c  # 覆盖或可新建 data['X_3d_c']
    model_vertices_c = (R_m2c @ model_vertices.T).T + t_m2c
    ...
    if T_delta_c1w_final is not None:
        ...
        for data in tqdm(all_optimization_data, desc="Final Visualizing"):
            ...
            visualize_projection(
                ...
                model_vertices=model_vertices_c
            )
