...
def infer(opt_file_path, image_raw, mask_raw, camK, frame_name) -> None:
    ...
    for object_lid in object_lids:
        ...
        for inst_j, instance in enumerate(instances):
            ...
            depth_image = inout.load_depth(depth_path) / 1000.0
            ...
            template_dir = "/home/zjr/Tracker/foundpose/results/templates/omniglue/plane/1"
...
def main() -> None:
    ...
    opts_path = "/home/zjr/Tracker/foundpose/configs/infer/plane_omniglue.json"
    rgb_dir = os.path.join(base_dir, "rgb")
    mask_dir = os.path.join(base_dir, "masks")
    colmap_dir = os.path.join(base_dir, "sparse/0")
    model_path = os.path.join(base_dir, "models/plane_m.obj")
    output_vis_dir = "/home/zjr/Tracker/foundpose/results/refine_model/plane"
    data_cache_path = os.path.join(os.path.dirname(opts_path), "cached_optimization_data_infer10_plane_m.pkl")
    ...
    R_m2c = all_corresps_data[2].best_pose["R_m2c"]
    t_m2c = all_corresps_data[2].best_pose["t_m2c"]
    T_m2c = np.eye(4)
    T_m2c[:3, :3] = R_m2c
    T_m2c[:3, 3] = t_m2c
    
    T_w2c = all_optimization_data[2]['T_w2c']
