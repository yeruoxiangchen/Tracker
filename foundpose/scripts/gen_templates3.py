...
def synthesize_templates(opts: GenTemplatesOpts) -> None: 
    ...
    if bbox_size > 10.0:
        print(f"模型单位疑似为毫米，自动转换为米，最大边长: {bbox_size} m")
        m.apply_scale(0.001)
    else:
        print(f"模型单位疑似为毫米，最大边长: {bbox_size} mm")
    out_path = "/home/zjr/Tracker/foundpose/datasets/plane/models/plane_m.obj"
    ...
    # 模型
    model_tpath = "/home/zjr/Tracker/foundpose/datasets/plane/models/plane_m.obj"
