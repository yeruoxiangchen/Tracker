...
def main() -> None:
    ...
    colmap_cameras = read_cameras_binary(cameras_bin_path)
    # for i, data_entry in enumerate(all_optimization_data):
    #     # 构建新的 K 矩阵
    #     K_colmap = np.array([[1089.0690450152401, 0, 360], [0, 1089.0690450152401, 640], [0, 0, 1]], dtype=np.float32)
    #     # 3. 替换 K 矩阵
    #     data_entry['K'] = K_colmap
