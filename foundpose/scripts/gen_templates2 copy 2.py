...
def synthesize_templates(opts: GenTemplatesOpts) -> None: 
    ...
    import trimesh
    model_path = "/home/zjr/Tracker/foundpose/datasets/plane/models/plane.ply"
    ...
    # 导出转换后的模型
    out_path = "/home/zjr/Tracker/foundpose/datasets/plane/models/plane_mm.obj"
    texture_path = "/home/zjr/Tracker/foundpose/datasets/plane/models/plane.jpg"
    # m.export(out_path)
    # 指定纹理图片
    ...
    camera_fov_y = 2 * np.arctan2(bop_camera['im_size'][1]/2, bop_camera['K'][1,1])
    camera_fov_x = 2 * np.arctan2(bop_camera['im_size'][0]/2, bop_camera['K'][0,0])
