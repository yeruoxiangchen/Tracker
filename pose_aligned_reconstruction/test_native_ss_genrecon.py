...
from pose_aligned_reconstruction.evaluate_native_ss_genrecon import (
    aggregate_records,
    candidate_checks,
)
...
from pose_aligned_reconstruction.train_native_ss_genrecon import (
    ema_ramp_decay,
...
def test_new_runtime_sources_do_not_import_direct_slat() -> None:
    ...
    for name in (
        ...
        assert "from pose_aligned_reconstruction.direct_slat" not in text
        assert "import pose_aligned_reconstruction.direct_slat" not in text
