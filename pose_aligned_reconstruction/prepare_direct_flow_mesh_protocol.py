...
def main() -> None:
    ...
    code_paths = (
        TRACKER_ROOT / "pose_aligned_reconstruction" / "prepare_direct_flow_mesh_protocol.py",
        TRACKER_ROOT / "pose_aligned_reconstruction" / "export_direct_flow_mesh_pairs.py",
        TRACKER_ROOT / "pose_aligned_reconstruction" / "eval_direct_flow.py",
        TRACKER_ROOT / "pose_aligned_reconstruction" / "direct_flow.py",
        TRACKER_ROOT / "pose_aligned_reconstruction" / "train_direct_flow.py",
        TRACKER_ROOT / "pose_aligned_reconstruction" / "tools" / "ninja",
        TRACKER_ROOT
        / "ReconViaGen"
        / "trellis"
        / "pipelines"
    ...
    ninja_label = "pose_aligned_reconstruction/tools/ninja"
