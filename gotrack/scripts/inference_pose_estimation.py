...
from gotrack.utils import data_util, logging, net_util, template_util, gen_repre_util
import warnings
from torch.utils.data import DataLoader
from gotrack.model import pipeline
...
def run_inference(cfg: DictConfig):
    OmegaConf.set_struct(cfg, False)    # 允许动态修改配置
