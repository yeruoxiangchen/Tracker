#!/usr/bin/env python3
"""Train Native-SLAT v2 on the reviewed ~1k single-object pool."""
...
def validate_args(args: argparse.Namespace) -> None:
    ...
    if int(args.condition_channels) != 1024:
        raise ValueError("Native-SLAT v2 binds DINO/GenReCon condition_channels=1024")
...
def main() -> None:
    ...
    if dataset.config.get("condition_arch") != "native_ss_genrecon_v2":
        raise RuntimeError("Native-SLAT v2 requires a native_ss_genrecon_v2 cache")
