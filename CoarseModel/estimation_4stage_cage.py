...
# from core.global_optimize_4stage_defor import optimize_global_pose, refine_model_with_deformation_graph
from core.global_optimize_4stage_cage import optimize_global_pose, refine_model_with_cage
...
def main() -> None:
    ...
    refined_vertices = refine_model_with_cage(
