...
class DatasetOpts(NamedTuple):
    ...
    crop_image_center: bool = False# False
    center_crop_size: Tuple[int, int] = (952, 532)  # For DINOv2 with 14x14 patches.
...
# def prepare_sample2(
#     image_path,
#     chunk_cameras: Mapping[int, PinholePlaneCameraModel],
# ) -> Dict[str, Any]:

#     opts = DatasetOpts()

#     # Camera parameters, im_id=0
#     camera = chunk_cameras[0]
