...
import inout, dataset_params

from config import AppConfig

from utils import (
    cluster_util,
    feature_util_lunkuo as feature_util,
    projector_util,
...
def generate_repre(
    ...
    base_repre_dir = os.path.join(AppConfig.OUTPUT_ROOT, "object_repre")
    ...
    repre.feat_vectors = F.normalize(feat_vectors, dim=1)
...
def generate_repre_from_list(opts: GenRepreOpts) -> None:
    ...
    if object_lids is None:
        datasets_path = AppConfig.OUTPUT_ROOT
