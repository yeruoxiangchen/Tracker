...
from core.preprocess_test import(
...
from core.global_optimize_deformationcontour_xiaoliehen_new_init import optimize_global_pose, refine_model_with_deformation_graph
...
def main() -> None:
    ...
    T_M2W_final, result = optimize_global_pose(
        ...
        all_corresps_data=all_corresps_data[:5],
