...
def main() -> None:
    ...
    validate_args(args)
    # Apply thread budgets before dataset/model work.  On the 8-rank A72 host,
    # leaving every rank at the machine-wide OpenMP default creates hundreds of
    # runnable threads and starves both the loader and CUDA launch path.
    ...
    model_summary = {
        **model_summary,
        ...
        "runtime_performance": {
            "profile": "a72_strict_perf_v1_fix1",
