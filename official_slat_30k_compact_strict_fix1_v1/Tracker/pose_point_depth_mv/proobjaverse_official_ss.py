...
def load_official_native_ss_deployment(
    ...
    """Load a passed held-out aggregate as a strict downstream deployment."""
    ...
    if (
        ...
        raise ValueError("official Native SS aggregate is not a passed frozen report")
    ...
    if (
        ...
        raise RuntimeError("official Native SS aggregate did not pass every deployment gate")
    validate_official_ss_domain_contract(domain)
    required = {
        "checkpoint",
        "checkpoint_sha256",
