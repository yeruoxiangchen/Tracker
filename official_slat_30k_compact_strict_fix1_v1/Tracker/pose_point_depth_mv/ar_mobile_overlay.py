...
def build_mobile_overlay_mesh(
    ...
    *,
    ...
    """Convert a COLMAP-world OBJ to a compact Unity-world binary mesh."""
    ...
    report = {
        ...
        "source_to_output": "(x,y,z)_colmap_world -> (x,y,-z)_unity_world",
        ...
        "bounds_min_unity_world": unity_vertices.min(axis=0).tolist(),
        "bounds_max_unity_world": unity_vertices.max(axis=0).tolist(),
        "reduction": reduction,
        "display_only": True,
