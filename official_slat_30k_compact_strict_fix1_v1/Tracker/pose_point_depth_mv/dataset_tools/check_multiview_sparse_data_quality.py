...
from pose_point_depth_mv.dataset_tools.build_objaverse_multiview_sparse_data import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--no_markdown",
        action="store_true",
        help="Write only JSON. Useful when one canonical audit Markdown is maintained elsewhere.",
    )
