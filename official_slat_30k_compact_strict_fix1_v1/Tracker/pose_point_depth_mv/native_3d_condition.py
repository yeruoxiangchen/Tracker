        ...
        *,
        ...
        if is_compact_manifest_pair(slat_manifest, lifting_manifest):
            ...
            self.identity = {
                ...
                "compact_pair_identity": compact.pair_identity,
                # Compact v2 always keeps its finite checks enabled.  The
                # official strict profile does not request the audited-cache
                # opt-out, so this is stricter without changing tensors.
                "compact_tensor_finite_checks": True,
            }
            return
        ...
        self.lifting = PoseLiftingCacheDataset(
            lifting_manifest,
            indices="all",
            check_tensor_finite=check_tensor_finite,
        )
