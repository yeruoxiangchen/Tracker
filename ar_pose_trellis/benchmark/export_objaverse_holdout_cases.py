...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_root", default=str(TRACKER_ROOT / "ar_pose_trellis" / "benchmark_outputs" / "objaverse_holdout_cases"))
    parser.add_argument("--testsets_out", default=str(TRACKER_ROOT / "ar_pose_trellis" / "benchmark_outputs" / "objaverse_holdout_testsets.json"))
