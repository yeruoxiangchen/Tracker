...
/home/zjr/anaconda3/envs/reconviagen/bin/python \
  ar_pose_trellis/dataset_tools/download_objaverse.py \
...
```bash
/home/zjr/anaconda3/envs/reconviagen/bin/python \
  ar_pose_trellis/dataset_tools/download_omniobject3d.py list
```
...
```bash
/home/zjr/anaconda3/envs/reconviagen/bin/python \
  ar_pose_trellis/dataset_tools/download_omniobject3d.py download \
...
```bash
/home/zjr/anaconda3/envs/reconviagen/bin/python \
  ar_pose_trellis/dataset_tools/download_omniobject3d.py get \
  --target-path /data/OmniObject3D/raw
```
